    ...
    if (r == 1.0) {
      ...
      for (i = 0; i < loop_ub; i++) {
        ...
        for (i1 = 0; i1 < b_loop_ub; i1++) {
          Sxx[i1] = Sxx1[static_cast<int>(b_select[i1]) - 1];
        }
      }
      ...
      for (i1 = 0; i1 <= loop_ub; i1++) {
        for (sizes_idx_0 = 0; sizes_idx_0 < b_loop_ub; sizes_idx_0++) {
          ret = i + sizes_idx_0;
          y[sizes_idx_0].re = 2.0 * Sxx[ret].re;
          y[sizes_idx_0].im = 2.0 * Sxx[ret].im;
        }
      }
      if (Sxx1.size(1) != 0) {
        ret = 1;
      ...
      if (b_loop_ub >= 0) {
        b_Sxx_unscaled_data = Sxx[b_select.size(1) - 1];
      }
      ...
      for (i = 0; i < ret; i++) {
        for (i1 = 0; i1 < sizes_idx_0; i1++) {
          Sxx[b_input_sizes_idx_0 + input_sizes_idx_0] = b_Sxx_unscaled_data;
        }
      }
    }

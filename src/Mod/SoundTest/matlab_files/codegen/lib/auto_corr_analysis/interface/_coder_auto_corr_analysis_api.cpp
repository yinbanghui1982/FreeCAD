//
// File: _coder_auto_corr_analysis_api.cpp
//
// MATLAB Coder version            : 5.4
// C/C++ source code generated on  : 27-Dec-2023 08:52:58
//
...
emlrtContext emlrtContextGlobal{
    ...
    "auto_corr_analysis",                                 // fFunctionName
                               ...
                               const char_T *identifier)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  y = emlrt_marshallIn(sp, emlrtAlias(dt), &thisId);
...
// Return Type  : void
//
void auto_corr_analysis_api(const mxArray *const prhs[2], int32_T nlhs,
                            const mxArray *plhs[2])
{
  coder::array<real_T, 2U> c;
  coder::array<real_T, 2U> lags2;
  ...
  auto_corr_analysis(x, dt, c, lags2);
  // Marshall function outputs
  c.no_free();
  plhs[0] = emlrt_marshallOut(c);
  if (nlhs > 1) {
    lags2.no_free();
    plhs[1] = emlrt_marshallOut(lags2);
  }
...
// Return Type  : void
//
void auto_corr_analysis_atexit()
{
  emlrtStack st{
      nullptr, // site
      nullptr, // tls
  ...
  auto_corr_analysis_xil_terminate();
  auto_corr_analysis_xil_shutdown();
...
// Return Type  : void
//
void auto_corr_analysis_terminate()
{
  emlrtStack st{
      nullptr, // site
      nullptr, // tls
...
//
// File trailer for _coder_auto_corr_analysis_api.cpp
//
// [EOF]
//

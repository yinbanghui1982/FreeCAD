/*
 * File: _coder_time_anslysis_api.c
 *
...
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *sig, const
  ...
  char_T *identifier, emxArray_real_T *y)
{
  ...
  b_emlrt_marshallIn(sp, emlrtAlias(sig), &thisId, y);
...
/*
 * File trailer for _coder_time_anslysis_api.c
 *
 * [EOF]
 */

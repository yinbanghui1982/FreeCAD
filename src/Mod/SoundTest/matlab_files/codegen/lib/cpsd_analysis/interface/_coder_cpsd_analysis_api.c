/*
 * File: _coder_cpsd_analysis_api.c
 *
  ...
  mxArray *plhs[3])
{
  ...
  emxArray_real_T *Pxy2;
  emxArray_real_T *arg2;
  emxArray_real_T *f;
  emxArray_real_T *x;
  emxArray_real_T *y;
  real_T Fs;
  ...
  emxInit_real_T(&st, &Pxy2, 2, true);
  emxInit_real_T(&st, &arg2, 2, true);
  ...
  Pxy2->canFreeData = false;
  plhs[0] = emlrt_marshallOut(Pxy2);
  emxFree_real_T(&Pxy2);
  emxFree_real_T(&y);
  emxFree_real_T(&x);
  if (nlhs > 1) {
    arg2->canFreeData = false;
...
/*
 * File trailer for _coder_cpsd_analysis_api.c
 *
 * [EOF]
 */

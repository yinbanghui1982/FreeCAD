...
// #include "matlab_files/codegen/lib/pingpu/pingpu.h"
// #include "matlab_files/codegen/lib/psd_analysis/psd_analysis.h"
// #include "matlab_files/codegen/lib/cpsd_analysis/cpsd_analysis.h"
// #include "matlab_files/codegen/lib/onethird/onethird.h"
// #include "matlab_files/codegen/lib/daopu_analysis/daopu_analysis.h"
...
void Analysis::freqAnalysis(int channel){
    ...
    // // Set the size of the array.
    // // Change this size to the value that the application requires.
    // time_tmp.set_size(length_freq);
    // data.set_size(length_freq);
    // // Loop over the array to initialize each element.
...
void Analysis::psdAnalysis(int channel){
    ...
    // noise.set_size(1,length_psd);
    // // Loop over the array to initialize each element.
    // for (int idx0{0}; idx0 < noise.size(1); idx0++) {
    //     // Set the value of the array element.
    //     // Change this value to the value that the application requires.
